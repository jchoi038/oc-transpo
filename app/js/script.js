...
const selectOptionsGrid = document.getElementsByClassName(
	"parking-lot-select-options--grid"
);
...
const parkingLots = document.getElementsByClassName("parking-lot--info-box");

//get the list container
const parentList = document.getElementsByClassName("parking-lot--info-list");
